// Use this as a template and edit as necessary!  :)

const path = require('path'); //Runs within node!
const HtmlWebpackPlugin = require('html-webpack-plugin'); // Import downloaded plugin
...
const config = {
  ...
  mode: 'development', // tells webpack to use its built-in optimisations according to the mode (could be dev or production)
  resolve: {
    // instructions on how to resolve modules (dependency resolution)
  ...
  performance: {
    ...
    hints: false, // Can toggle on and off
  },
  plugins: [
    // plugins we are using to help with compiling - check documentation as required
